...
set_property PACKAGE_PIN V2 [get_ports {parallel_in[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_in[0]}]
set_property PACKAGE_PIN T3 [get_ports {parallel_in[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_in[1]}]
set_property PACKAGE_PIN T2 [get_ports {parallel_in[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_in[2]}]
set_property PACKAGE_PIN R3 [get_ports {parallel_in[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_in[3]}]
set_property PACKAGE_PIN W2 [get_ports {parallel_in[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_in[4]}]
set_property PACKAGE_PIN U1 [get_ports {parallel_in[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_in[5]}]
set_property PACKAGE_PIN T1 [get_ports {parallel_in[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_in[6]}]
set_property PACKAGE_PIN R2 [get_ports {parallel_in[7]}]
...
set_property PACKAGE_PIN V13 [get_ports {parallel_out[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_out[0]}]
set_property PACKAGE_PIN V3 [get_ports {parallel_out[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_out[1]}]
set_property PACKAGE_PIN W3 [get_ports {parallel_out[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_out[2]}]
set_property PACKAGE_PIN U3 [get_ports {parallel_out[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_out[3]}]
set_property PACKAGE_PIN P3 [get_ports {parallel_out[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_out[4]}]
set_property PACKAGE_PIN N3 [get_ports {parallel_out[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_out[5]}]
set_property PACKAGE_PIN P1 [get_ports {parallel_out[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {parallel_out[6]}]
set_property PACKAGE_PIN L1 [get_ports {parallel_out[7]}]
...
set_property PACKAGE_PIN U17 [get_ports {send}]
...
set_property PACKAGE_PIN B18 [get_ports usb_in]
set_property IOSTANDARD LVCMOS33 [get_ports usb_in]
#Bank = 16, Pin name = ,					Sch name = UART_RXD_OUT
set_property PACKAGE_PIN A18 [get_ports usb_out]
set_property IOSTANDARD LVCMOS33 [get_ports usb_out]
